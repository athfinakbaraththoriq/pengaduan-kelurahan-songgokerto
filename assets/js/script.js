...
Tanggal Pengaduan: ${tanggal}, ${waktu} WIB`;
    ...
    showToast("Pengaduan siap dikirim. WhatsApp telah dibuka pada tab baru.");
  }
  ...
  document.getElementById("contactWhatsappBtn").addEventListener("click", (e) => {
    ...
    window.open(`https://wa.me/${nomorWhatsApp}?text=${encodeURIComponent(pesan)}`, "_blank", "noopener");
  });
